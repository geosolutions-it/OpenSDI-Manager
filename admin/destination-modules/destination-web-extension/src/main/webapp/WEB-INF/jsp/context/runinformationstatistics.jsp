		...
		<div class="container resume">
			...
			<table class="table table-hover">
				<tr>
					...
					<th>Excution date</th>
					<th>Check Date</th>
					<c:if test="${not empty runInfo.extraInformation and not empty runInfo.extraInformation.trace}">
				...
				<tr>
					...
					<c:if test="${not empty runInfo.extraInformation and not empty runInfo.extraInformation.trace}">
					<td>${runInfo.extraInformation.trace.nr_rec_storage}</td>
					<td>${runInfo.extraInformation.trace.nr_rec_scartati}</td>
					</c:if>
				</tr>
			</table>
		</div>
