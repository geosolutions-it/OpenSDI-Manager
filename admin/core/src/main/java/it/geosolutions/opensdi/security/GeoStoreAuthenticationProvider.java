package it.geosolutions.opensdi.security;
...
public class GeoStoreAuthenticationProvider implements AuthenticationProvider {
	...
	AdministratorGeoStoreClient geoStoreClient;
        ...
        /**
         * GeoBatchClient in the applicationContext 
         */
        @Autowired
	...
	public Authentication authenticate(Authentication authentication) {
		...
		// Use also on geobatch client
		geoBatchClient.setGeobatchUsername(us);
                geoBatchClient.setGeobatchPassword(pw);
		User user = null;
		try {
